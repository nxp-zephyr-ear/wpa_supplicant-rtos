...
#define wpa_printf(level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_printf_impl(level, fmt, ##__VA_ARGS__))
...
#define wpa_hexdump_key(level, title, buf, len) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_hexdump_key_impl(level, title, buf, len))
...
#define wpa_hexdump_ascii(level, title, buf, len) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_hexdump_ascii_impl(level, title, buf, len))
...
#define wpa_hexdump_ascii_key(level, title, buf, len) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_hexdump_ascii_key_impl(level, title, buf, len));
...
#define wpa_msg(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_impl(ctx, level, fmt, ##__VA_ARGS__))
...
#define wpa_msg_ctrl(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_ctrl_impl(ctx, level, fmt, ##__VA_ARGS__))
...
#define wpa_msg_global(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_global_impl(ctx, level, fmt, ##__VA_ARGS__))
...
#define wpa_msg_global_ctrl(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_global_ctrl_impl(ctx, level, fmt, ##__VA_ARGS__))
...
#define wpa_msg_no_global(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_no_global_impl(ctx, level, fmt, ##__VA_ARGS__))
...
#define wpa_msg_global_only(ctx, level, fmt, ...) \
    wpa_debug_cond_run(wpa_debug_level_enabled(level), wpa_msg_global_only_impl(ctx, level, fmt, ##__VA_ARGS__))
...
static inline int wpa_debug_open_file(const char *path)
{
    return 0;
}
