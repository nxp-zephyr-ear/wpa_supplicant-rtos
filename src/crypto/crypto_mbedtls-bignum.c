...
{
    return mbedtls_mpi_random((mbedtls_mpi *)r, 0, (mbedtls_mpi *)m, f_rng, NULL);
}
...
{
    return mbedtls_mpi_div_mpi((mbedtls_mpi *)c, NULL, (const mbedtls_mpi *)a, (const mbedtls_mpi *)b) ? -1 : 0;
}
...
{
    return mbedtls_mpi_exp_mod((mbedtls_mpi *)c, (mbedtls_mpi *)a, (mbedtls_mpi *)a, (mbedtls_mpi *)b, NULL);
}
...
int crypto_bignum_to_string(const struct crypto_bignum *a, u8 *buf, size_t buflen, size_t padlen)
{
    ...
    os_memset(buf, 0, offset);
    mbedtls_mpi_write_string((mbedtls_mpi *)a, 16, (char *)(buf + offset), mbedtls_mpi_size((mbedtls_mpi *)a), &outlen);
