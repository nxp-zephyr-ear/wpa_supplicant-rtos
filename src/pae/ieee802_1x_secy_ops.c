...
int secy_cp_control_encrypt(struct ieee802_1x_kay *kay, bool enabled)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy enable_encrypt operation not supported");
        return -1;
    }
...
int secy_get_capability(struct ieee802_1x_kay *kay, enum macsec_cap *cap)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy macsec_get_capability operation not supported");
        return -1;
    }
...
int secy_get_transmit_next_pn(struct ieee802_1x_kay *kay, struct transmit_sa *txsa)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy get_transmit_next_pn operation not supported");
        return -1;
    }
...
int secy_set_transmit_next_pn(struct ieee802_1x_kay *kay, struct transmit_sa *txsa)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy set_transmit_next_pn operation not supported");
        return -1;
    }
...
int secy_set_receive_lowest_pn(struct ieee802_1x_kay *kay, struct receive_sa *rxsa)
{
    struct ieee802_1x_kay_ctx *ops;
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy set_receive_lowest_pn operation not supported");
        return -1;
    }
...
int secy_delete_receive_sa(struct ieee802_1x_kay *kay, struct receive_sa *rxsa)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy delete_receive_sa operation not supported");
        return -1;
    }
...
int secy_delete_transmit_sa(struct ieee802_1x_kay *kay, struct transmit_sa *txsa)
{
    ...
    {
        wpa_printf(MSG_ERROR, "KaY: secy delete_transmit_sa operation not supported");
        return -1;
    }
