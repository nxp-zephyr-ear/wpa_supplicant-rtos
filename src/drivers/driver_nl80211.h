...
#define nla_nest_start(msg, attrtype) nla_nest_start(msg, NLA_F_NESTED | (attrtype))
#endif
...
extern int wpa_driver_nl80211_driver_event(
    struct wpa_driver_nl80211_data *drv, u32 vendor_id, u32 subcmd, u8 *data, size_t len);
