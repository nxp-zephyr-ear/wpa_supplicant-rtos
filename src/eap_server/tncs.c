...
static TNC_Result TNC_TNCS_ReportMessageTypes(TNC_IMVID imvID, TNC_MessageTypeList supportedTypes, TNC_UInt32 typeCount)
{
    TNC_UInt32 i;
    struct tnc_if_imv *imv;
    ...
    imv->supported_types = os_memdup(supportedTypes, typeCount * sizeof(TNC_MessageType));
                                       ...
                                       TNC_MessageType messageType)
{
    ...
    b64 = wpa_base64_encode(message, messageLength, &b64len);
    if (b64 == NULL)
        return TNC_RESULT_FATAL;
    ...
    tncs->imv_data[imvID].imv_send_len = os_snprintf((char *)tncs->imv_data[imvID].imv_send, b64len + 100,
...
static TNC_Result TNC_TNCS_RequestHandshakeRetry(TNC_IMVID imvID, TNC_ConnectionID connectionID, TNC_RetryReason reason)
{
...
static TNC_Result TNC_TNCS_ProvideRecommendation(TNC_IMVID imvID,
                                                 TNC_ConnectionID connectionID,
                                                 ...
                                                 TNC_IMV_Evaluation_Result evaluation)
{
    ...
    wpa_printf(MSG_DEBUG,
               ...
               (unsigned long)imvID, (unsigned long)connectionID, (unsigned long)recommendation,
...
static TNC_Result TNC_TNCS_GetAttribute(TNC_IMVID imvID,
                                        TNC_ConnectionID connectionID,
...
static TNC_Result TNC_TNCS_BindFunction(TNC_IMVID imvID, char *functionName, void **pOutFunctionPointer)
{
    wpa_printf(MSG_DEBUG,
...
static unsigned char *tncs_get_base64(char *start, size_t *decoded_len)
{
    ...
    *pos2 = '\0';
    ...
    decoded = wpa_base64_decode(pos, os_strlen(pos), decoded_len);
    *pos2   = '<';
    if (decoded == NULL)
    {
