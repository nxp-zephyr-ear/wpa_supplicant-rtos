...
static struct sock_filter dhcp_sock_filter_insns[] = {
    {0x80, 0, 0, 0x00000000}, {0x35, 0, 12, 0x00000116}, {0x28, 0, 0, 0x0000000c}, {0x15, 0, 10, 0x00000800},
    {0x30, 0, 0, 0x00000017}, {0x15, 0, 8, 0x00000011},  {0x28, 0, 0, 0x00000014}, {0x45, 6, 0, 0x00001fff},
    {0xb1, 0, 0, 0x0000000e}, {0x48, 0, 0, 0x0000000e},  {0x15, 0, 3, 0x00000043}, {0x48, 0, 0, 0x00000010},
    {0x15, 0, 1, 0x00000044}, {0x6, 0, 0, 0x00000bb8},   {0x6, 0, 0, 0x00000000},
};
...
static struct sock_filter ndisc_sock_filter_insns[] = {
    {0x30, 0, 0, 0x00000000}, {0x45, 0, 5, 0x00000001}, {0x28, 0, 0, 0x0000000c}, {0x15, 0, 3, 0x000086dd},
    {0x30, 0, 0, 0x00000014}, {0x15, 0, 1, 0x0000003a}, {0x6, 0, 0, 0x000005dc},  {0x6, 0, 0, 0x00000000},
};
...
static void l2_packet_receive(int sock, void *eloop_ctx, void *sock_ctx)
{
    ...
    if (l2->fd_br_rx >= 0)
    {
         ...
         */
        if (l2->num_rx_br <= 1 &&
            (os_memcmp(eth->h_dest, l2->own_addr, ETH_ALEN) == 0 || is_multicast_ether_addr(eth->h_dest)))
        {
            wpa_printf(MSG_DEBUG,
                       "l2_packet_receive: Main packet socket for %s seems to have working RX - close workaround "
                       "bridge socket",
                       l2->ifname);
        ...
        if (l2->last_from_br_prev && os_memcmp(hash, l2->last_hash_prev, SHA1_MAC_LEN) == 0)
        {
                                      ...
                                      int l2_hdr)
{
    ...
    if (rx_callback && bind(l2->fd, (struct sockaddr *)&ll, sizeof(ll)) < 0)
    {
    ...
    int l2_hdr)
{
    struct l2_packet_data *l2;
#ifndef CONFIG_NO_LINUX_PACKET_SOCKET_WAR
    struct sock_filter ethertype_sock_filter_insns[] = {/* Load ethertype */
