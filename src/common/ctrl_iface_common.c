    ...
    switch (a->ss_family)
    {
        ...
        case AF_INET6:
        {
            ...
            if (in6_a->sin6_port != in6_b->sin6_port)
                return 1;
            if (os_memcmp(&in6_a->sin6_addr, &in6_b->sin6_addr, sizeof(in6_a->sin6_addr)) != 0)
                return 1;
            break;
        }
        ...
        case AF_UNIX:
        {
            ...
            if (a_len != b_len ||
                os_memcmp(u_a->sun_path, u_b->sun_path, a_len - offsetof(struct sockaddr_un, sun_path)) != 0)
                return 1;
            break;
        }
    ...
    switch (sock->ss_family)
    {
        ...
        case AF_INET6:
        {
            /*            char host[NI_MAXHOST]    = {0};
                        ...
                        getnameinfo((struct sockaddr *)sock, socklen, host, sizeof(host), service, sizeof(service),
               NI_NUMERICHOST);
        ...
        case AF_UNIX:
        {
            ...
            printf_encode(addr_txt, sizeof(addr_txt), (u8 *)((struct sockaddr_un *)sock)->sun_path,
