...
class WpaGui : public QMainWindow, public Ui::WpaGui
{
   ...
   public:
    ...
    WpaGui(QApplication *app, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags fl = 0);
    ~WpaGui();
   ...
   public slots:
    ...
    virtual void showTrayMessage(QSystemTrayIcon::MessageIcon type, int sec, const QString &msg);
