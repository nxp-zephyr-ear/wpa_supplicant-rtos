...
UserDataRequest::UserDataRequest(QWidget *parent, const char *, bool, Qt::WindowFlags) : QDialog(parent)
{
    setupUi(this);
...
void UserDataRequest::sendReply()
{
    ...
    QString cmd = QString(WPA_CTRL_RSP) + field + '-' + QString::number(networkid) + ':' + queryEdit->text();
