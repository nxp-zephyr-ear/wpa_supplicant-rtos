...
SignalBar::SignalBar(QObject *parent) : QStyledItemDelegate(parent)
{
}
...
void SignalBar::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
